...
用法（全量）：
  python runner.py run --repo-root . --tests test/generated_unit --source-dirs . --baseline test/generated_unit/test_cases.json --output .test/run_result.json

用法（单文件）：
  python runner.py run --repo-root . --test-file test/generated_unit/core/test_parser.py --source-dirs core --scope-sources core/parser.py --baseline test/generated_unit/test_cases.json --output .test/run_results/core__parser_py.json
"""
